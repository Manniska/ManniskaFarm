-- =====================================================================
--  MANNISKAFARM V14.1 - MASTER TABLE ARCHITECTURE & KINEMATIC SUITE
-- =====================================================================
...
-- VISUALIZER INITIALIZATION (FIX FOR NIL TRANSPARENCY ERROR)
Core.visualizerFolder = workspace:FindFirstChild("ManniskaPathVisualizer") or Instance.new("Folder")
Core.visualizerFolder.Name = "ManniskaPathVisualizer"
Core.visualizerFolder.Parent = workspace

Core.visualizerAnchor = workspace:FindFirstChild("ManniskaVisAnchor") or Instance.new("Part")
Core.visualizerAnchor.Name = "ManniskaVisAnchor"
Core.visualizerAnchor.Anchored = true
Core.visualizerAnchor.CanCollide = false
Core.visualizerAnchor.Transparency = 1
Core.visualizerAnchor.Position = Vector3.zero
Core.visualizerAnchor.Parent = workspace

Core.activeNodeHalo = workspace:FindFirstChild("ActiveTargetHalo") or Instance.new("Part")
Core.activeNodeHalo.Name = "ActiveTargetHalo"
Core.activeNodeHalo.Shape = Enum.PartType.Cylinder
Core.activeNodeHalo.Size = Vector3.new(0.3, 3, 3)
Core.activeNodeHalo.Anchored = true
Core.activeNodeHalo.CanCollide = false
Core.activeNodeHalo.Material = Enum.Material.Neon
Core.activeNodeHalo.Color = Color3.fromRGB(255, 230, 0)
Core.activeNodeHalo.Transparency = 1
Core.activeNodeHalo.CastShadow = false
Core.activeNodeHalo.Parent = Core.visualizerFolder
...
titleLabel.Size = UDim2.new(0, 145, 1, 0); titleLabel.BackgroundTransparency = 1; titleLabel.Text = "MANNISKAFARM V14.1"
...
print("🚀 Autofarm V14.1 (Master Engine Override) Loaded.")
